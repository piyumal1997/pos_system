    ...
    public partial class ReturnsForm : Form
    {
        ...
        private void btnSearchBill_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _billExpired = difference.TotalDays > 120;

                if (_billExpired)
                {
                    ThemedMessageBox.Show($"This bill is from {_billDate:yyyy-MM-dd} and is more than 120 days old. Returns are not allowed.",
